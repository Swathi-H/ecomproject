...
public class AdminController {
	...
	public String addProduct(@Valid @ModelAttribute("product")Product product,BindingResult result,ModelMap model) {
		...
		File file=new File(request.getRealPath("assets//images//products//electronics//table//"));
		/*System.out.println(file.exists());*/
		if(!file.exists()){
			file.mkdirs();
		}
		File storagepath=new File(request.getRealPath("assets//images//products//electronics//table//")+File.separator+product.getProductName()+".jpg");
		try{
